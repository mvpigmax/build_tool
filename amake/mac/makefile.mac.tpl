...
CPP=g++ -fpic -Wno-invalid-source-encoding
LINK=g++
LIB32=ar -ru
PREP=g++ -E -P
PUMP=pump
...
!!let am_debug_multithread_cppflags="-O1 -g -pthread "!!
!!let am_debug_singlethread_cppflags="-O1 -g"!!
!!let am_release_multithread_cppflags="-O1 -g -pthread "!!
!!let am_release_singlethread_cppflags="-O1 -g"!!
