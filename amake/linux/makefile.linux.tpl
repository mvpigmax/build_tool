...
!!let am_debug_multithread_cppflags="-O1 -g -pthread -m64"!!
!!let am_debug_singlethread_cppflags="-O1 -g -m64"!!
!!let am_release_multithread_cppflags="-O1 -g -pthread -m64"!!
!!let am_release_singlethread_cppflags="-O1 -g -m64"!!
!!let am_profile_cppflags="-p"!!
!!let am_output_ldindicate="-o "!!
!!let am_implib_ldindicate=""!!
!!let am_libs="-lpthread -lrt"!!
!!let am_basic_exe_ldflags=""!!
!!let am_basic_lib_ldflags="-static"!!
!!let am_basic_dll_ldflags="-shared -Wl,-Bsymbolic"!!
!!let am_debug_ldflags="-O1 -g -m64"!!
