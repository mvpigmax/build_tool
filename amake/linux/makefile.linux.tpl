...
!!let am_debug_multithread_cppflags="-O3 -g -pthread -m64"!!
!!let am_debug_singlethread_cppflags="-O3 -g -m64"!!
!!let am_release_multithread_cppflags="-O3 -g -pthread -m64"!!
!!let am_release_singlethread_cppflags="-O3 -g -m64"!!
