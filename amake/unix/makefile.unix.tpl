...
!!let am_debug_multithread_cppflags="-O3 -pthread -mlp64"!!
!!let am_debug_singlethread_cppflags="-O3 -mlp64"!!
!!let am_release_multithread_cppflags="-O3 -pthread -mlp64"!!
!!let am_release_singlethread_cppflags="-O3 -mlp64"!!
